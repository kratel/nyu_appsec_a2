...
class AuthForm(FlaskForm):
	username = StringField(label='Username', id='uname', validators=[DataRequired(), Regexp(regex='^(?=.{8,20}$)[a-zA-Z0-9._]+$', message='Registration failure. Invalid char in username or not between 8 - 20 chars')])
	...
	mfa = StringField(label='2FA', id='2fa', validators=[Optional()])
